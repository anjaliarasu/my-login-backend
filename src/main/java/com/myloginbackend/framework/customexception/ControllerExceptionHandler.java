package com.myloginbackend.framework.customexception;
...
import com.myloginbackend.model.wrapper.Message;
import com.myloginbackend.model.wrapper.MessageType;
...
public class ControllerExceptionHandler {
	...
	@ResponseStatus(value = HttpStatus.NOT_FOUND)
	public Message handleUserNameNotFound(HttpServletRequest request, UsernameNotFoundException noSuchElementException) {
		...
		logger.error("", noSuchElementException);
		return ConstructMessage(MessageType.ERROR, messages.toString(), System.currentTimeMillis(),
				String.valueOf(HttpStatus.NOT_FOUND.value()), "User not found",
				UsernameNotFoundException.class.getName(),
				request.getRequestURI().substring(request.getContextPath().length()), noSuchElementException);
	}
